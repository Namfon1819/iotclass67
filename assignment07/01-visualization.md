...
3) จากนั้นให้เราไปบันทึกหรือหารูปแบบ plan ที่เราจะทำมา แล้วมา  export plan ออกมาเป็น svg เพื่อเอาไปใช้ในขั้นตอนต่อไป
4) จากนั้นให้เราใช้กล่อง text สร้าง ชื่อกล่องว่า room1-10 ไปวางตามห้องต่างๆและกด save เพื่อให้รูปมันมาโผล่ที่หน้า edit panal ได้เลย
5) จากนั้น เราก็จะลงไปล่างสุดกดตรงปุ่ม explan เพื่อดูว่าห้องแต่ละห้องที่เราสร้างตรงกับเลขอะไร
6) จากนั้นเราก็จะมาสร้าง rule ให้แต่ละห้อง

    ![image](https://github.com/user-attachments/assets/c6bcb75e-d46a-40ff-a0ba-a1425786ccc1)

8) แต่ละ rule เราจะมีการ metric type ละมีการเลือกชื่อของ sensor ว่าห้องนี่จะให้ sensor ตัวไหนบอกอุณหภูมิ และมีการกำหนดอุณภูมิและสีว่าถ้าอุณหภูมิเกิน 28 ให้เปลี่ยนเป็นสีแดง
9) ต่อมามาเปลี่ยนหัวข้อ query ตรง option ตอนเเรกมันเป็น json  ให้ลบออก เเล้ว extract เเต่ sensor name ตามในรูป

   ![image](https://github.com/user-attachments/assets/be939980-7f5a-42f5-98a0-afd3bc14a904)

11) ให้ใส่ข้างบนเป็น {{sensor_name}} เพราะว่าจะได้ง่ายต่อการใช้งานตอนเลือกชื่อในช่อง rule 
12) จากนั้นก็กด save ด้วยน่ะเดี๋ยวที่สร้างมาหายหมด
